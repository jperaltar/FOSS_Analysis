...
import scancode.src.commoncode.fileutils as fileutils
import scancode.src.commoncode.filetype as filetype

import scancode.src.typecode
from scancode.src.typecode import magic2

LOG = logging.getLogger(__name__)


# Python mimetypes path setup using Apache mimetypes DB
os.environ['XDG_DATA_DIRS'] = os.path.join(scancode.src.typecode.data_dir, 'apache')
os.environ['XDG_DATA_HOME'] = os.environ['XDG_DATA_DIRS']
APACHE_MIME_TYPES = os.path.join(scancode.src.typecode.data_dir, 'apache', 'mime.types')
