...
import scancode.src.commoncode as commoncode
from scancode.src.textcode import analysis
from scancode.src.cluecode import copyrights_hint
...
def detect_copyrights(string):
    ...
    for numbered_lines in candidate_lines(analysis.text_lines(string)):
...
def detect(string):
    ...
    years = []
    holders = []
    for cp, auth, yr, hold, _start, _end in detect_copyrights(string):
