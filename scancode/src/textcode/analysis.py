...
import scancode.src.typecode.contenttype
from scancode.src.textcode import strings
from scancode.src.textcode import pdf
from scancode.src.textcode import markup
